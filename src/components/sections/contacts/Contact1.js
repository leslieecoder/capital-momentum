            ...
            >
              {type === 3 ? (
                ...
                <div className="section__title__small">
                  <span>¡Construye tu propio camino hacia la libertad financiera!</span>
                </div>
              ) : (
                <div className="section__title__button">
              ...
              <div className="section__title__heading">
                <h3>¡Construye tu propio camino hacia la libertad financiera!</h3>
              </div>
            </div>
          </div>
              ...
              <div className="row">
                ...
                <div className="col-xl-12">
                  <div className="contact__button">
                    <ButtonPrimary text="ENVIAR MENSAJE" type={"submit"} />
                  </div>
                </div>
              </div>
            </div>
