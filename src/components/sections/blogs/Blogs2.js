          ...
          <div className="col-xl-6 col-lg-6 col-md-6 col-12">
            <div className="section__title section__title--2 section__title--3 ">
              ...
              <div className="section__title__heading">
                <h3>Conoce más y transforma tu futuro</h3>
                <p>Explora estrategias, historias y consejos para maximizar tus ingresos y aprovechar las mejores oportunidades en trading, bienes raíces y más.</p>
              </div>
            </div>
          </div>
